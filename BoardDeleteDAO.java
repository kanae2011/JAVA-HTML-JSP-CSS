...
public class BoardDeleteDAO {
	...
	public static void main(String[] args) {
		...
		try {
		//삭제 할 글번호 받기
		System.out.print("삭제 할 글 번호를 입력-> ");
		String data = scanner.nextLine();
		long no = Long.parseLong(data);
		
		//DB처리 - DELETE : INSERT / UPDATE / DELETE -> 같은부류의 프로그램(사용객체2개, 리턴타입이 int) 
		//1.드라이버 확인
		...
		//3.쿼리 작성
		String sql = "DELETE FROM board WHERE no = ?"; // ? : 값으로 대체 되는 문자 
		...
		//6.출력
		if(result > 0) System.out.println("게시판 글 번호 " + no + "번 삭제완료");
